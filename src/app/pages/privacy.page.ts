  ...
  template: `
    <div class="min-h-screen bg-background text-foreground">
      ...
      <main class="mx-auto max-w-4xl px-4 py-10 md:px-6">
        ...
        <h1 class="font-ar-display mt-3 text-4xl font-black tracking-tight md:text-5xl">{{ 'privacy.title' | transloco }}</h1>
        <p class="font-ar-text mt-5 text-lg leading-8 text-muted-foreground">{{ 'privacy.intro' | transloco }}</p>
