  ...
  en: {
    ...
    admin: {
      ...
      purchases: {
        ...
        approve: 'Approve',
        reject: 'Reject',
        approvedNote: 'Approved by admin',
        approved: 'Purchase {{ id }} approved.',
        rejected: 'Purchase {{ id }} rejected.',
        rejectionReason: 'Enter rejection reason (at least 3 characters)',
        errors: {
          load: 'Unable to load purchases',
          approve: 'Unable to approve purchase',
          reject: 'Unable to reject purchase',
        },
      },
      wallets: {
        kicker: 'Admin / Wallets',
        ...
        freeze: 'Freeze',
        unfreeze: 'Unfreeze',
        promptAdd: 'How many coins would you like to add?',
        promptRemove: 'How many coins would you like to remove?',
        promptReason: 'Enter reason (at least 3 characters)',
        promptFreeze: 'Enter freeze reason (at least 3 characters)',
        promptUnfreeze: 'Enter unfreeze reason (at least 3 characters)',
        errors: {
          load: 'Unable to load wallets',
          amount: 'Enter a valid positive amount.',
          reason: 'Reason must be at least 3 characters.',
          adjust: 'Unable to adjust wallet balance',
          freeze: 'Unable to update wallet freeze status',
        },
      },
      vouchers: {
        kicker: 'Admin / Vouchers',
        ...
        disable: 'Disable',
        enable: 'Enable',
        saved: 'Voucher saved successfully.',
        kinds: {
        ...
        errors: {
          load: 'Unable to load vouchers',
          required: 'Code and title must be at least 3 characters.',
          save: 'Unable to save voucher',
          status: 'Unable to update voucher status',
        },
      },
      placeholder: {
        title: 'Admin Section',
  ...
  ar: {
    ...
    admin: {
      ...
      purchases: {
        ...
        approve: 'قبول',
        reject: 'رفض',
        approvedNote: 'تمت الموافقة بواسطة الإدارة',
        approved: 'تمت الموافقة على الطلب {{ id }}.',
        rejected: 'تم رفض الطلب {{ id }}.',
        rejectionReason: 'أدخل سبب الرفض (3 أحرف على الأقل)',
        errors: {
          load: 'تعذر تحميل المشتريات',
          approve: 'تعذر الموافقة على الطلب',
          reject: 'تعذر رفض الطلب',
        },
      },
      wallets: {
        kicker: 'الإدارة / المحافظ',
        title: 'التحكم في المحافظ',
        empty: 'لا توجد محافظ.',
        user: 'المستخدم',
        won: 'ربح',
        spent: 'أنفق',
        ...
        promptAdd: 'كم عدد العملات التي تريد إضافتها؟',
        promptRemove: 'كم عدد العملات التي تريد خصمها؟',
        promptReason: 'أدخل السبب (3 أحرف على الأقل)',
        promptFreeze: 'أدخل سبب التجميد (3 أحرف على الأقل)',
        promptUnfreeze: 'أدخل سبب إلغاء التجميد (3 أحرف على الأقل)',
        errors: {
          load: 'تعذر تحميل المحافظ',
          amount: 'أدخل قيمة صحيحة أكبر من صفر.',
          reason: 'السبب يجب أن يكون 3 أحرف على الأقل.',
          adjust: 'تعذر تعديل رصيد المحفظة',
          freeze: 'تعذر تحديث حالة تجميد المحفظة',
        },
      },
      vouchers: {
        kicker: 'الإدارة / القسائم',
        title: 'إدارة القسائم',
        createVoucher: 'إنشاء قسيمة',
        editVoucher: 'تعديل القسيمة',
        updateVoucher: 'تحديث القسيمة',
        reset: 'إعادة تعيين',
        code: 'الكود',
        fieldTitle: 'العنوان',
        description: 'الوصف',
        ...
        maxTotalUses: 'الحد الأقصى للاستخدام الكلي',
        ...
        disable: 'تعطيل',
        enable: 'تفعيل',
        saved: 'تم حفظ القسيمة بنجاح.',
        kinds: {
          free_coins: 'عملات مجانية',
          discount_percent: 'خصم بالنسبة المئوية',
          discount_fixed: 'خصم ثابت',
        },
        errors: {
          load: 'تعذر تحميل القسائم',
          required: 'يجب أن يكون الكود والعنوان 3 أحرف على الأقل.',
          save: 'تعذر حفظ القسيمة',
          status: 'تعذر تحديث حالة القسيمة',
        },
      },
      placeholder: {
        title: 'قسم الإدارة',
