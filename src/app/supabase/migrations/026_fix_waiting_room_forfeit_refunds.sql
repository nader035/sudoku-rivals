-- ============================================================================
-- Fix waiting-room forfeits: refund any leaving player's entry fee
-- and keep room cleanup consistent when players leave.
-- ============================================================================
...
BEGIN
  ...
  IF p_player_id IS DISTINCT FROM current_player_id() AND NOT is_admin() THEN
...
DO $$
BEGIN
  RAISE NOTICE 'forfeit_room updated: waiting-room exits now refund entry fees and empty rooms are removed.';
END $$;
